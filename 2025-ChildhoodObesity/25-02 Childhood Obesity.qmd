...
ggsave("production plot new.png", scale = .45, width = 15, height = 8)
...
oriau_byti2 %>% 
  count(std_name) %>% 
  summarise(total_au = sum(!is.na(std_name)))
```
